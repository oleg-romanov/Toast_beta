...
final class OnboardingView: UIView {
    ...
    lazy var logoImageView: UIImageView = UIImageView(image: Assets.logo.image)
    ...
    let skipButton: ButtonSecondary = ButtonSecondary(title: Text.Onboarding.skip)
    let nextButton: ButtonDefault = ButtonDefault(title: Text.Onboarding.next)
    ...
    private var dataSource: SlidesDataSource = SlidesDataSource()
